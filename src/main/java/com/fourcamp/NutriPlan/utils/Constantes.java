...
public class Constantes {
    ...
    public static final String MSG_SENHA_INVALIDO = "Senha inválida. A senha deve ter no mínimo 8 caracteres, contendo letras, números e pelo menos um caractere especial (@, #, %, &, $).";
    public static final String MSG_DATA_INVALIDO = "O usuário deve ter mais de 18 anos.";
